...
#define VOX_PROFILE 0
	...
	#define VOX_PROFILE_SCOPE(name)  LEVEL1(::Voxen::InstrumentationTimer timer, __LINE__) (name);
	#define VOX_PROFILE_FUNCTION() VOX_PROFILE_SCOPE(__FUNCSIG__)
#else
	#define VOX_PROFILE_BEGIN_SESSION(name, filepath)
	#define VOX_PROFILE_END_SESSION()
	#define VOX_PROFILE_SCOPE(name)
	#define VOX_PROFILE_FUNCTION()
#endif